...
$language['ACP_USER_GROUP']='Nastavení uživatelských skupin';
...
$language['ACP_CENSORED']='Nastavení cenzurovaných slov';
...
$language['ACP_MASSPM']='Hromadný osobní email';
...
$language['SETTING_INTERVAL_MIN_REANNOUNCE']='Minimumální reannounce interval (číslo v sekundách)';
...
$language['SETTING_OVERRIDE_IP']='Povolit uživatelům přepsání detekopané IP';
