...
$language['MNU_UCP_HOME']='Uživatelský panel, Domů';
$language['MNU_UCP_IN']='Vaše soukromá schránka';
...
$language['TRACKER_INFO']=$users.' uživatelé, sledování '.$torrents.' torrenty ('.$seeds.' seederů, '.$leechers.' leecherů, '.$percent.'%)';
